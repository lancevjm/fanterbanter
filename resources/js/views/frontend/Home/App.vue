    ...
    <div class="surface-0 flex justify-content-center">
        <div id="home" class="landing-wrapper overflow-hidden">
            <div class="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static mb-3">
                <a class="flex align-items-center" href="#"> <img :src="logoUrl" alt="Fanter Banter Logo" height="50" class="mr-0 lg:mr-2" /><span class="text-900 font-medium text-2xl line-height-3 mr-8">FANTER BANTER</span> </a>
            ...
            <div
                ...
                style="width:90%; background: linear-gradient(0deg, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, 0.2)), radial-gradient(77.36% 256.97% at 77.36% 57.52%, rgb(238, 239, 175) 0%, rgb(195, 227, 250) 100%);"
            >
                ...
                <div class="grid grid-nogutter text-800">
                    ...
                    <div class="col-12 md:col-6 overflow-hidden">
                        <div class="heropic">
                            <img src="/assets/img/traders.webp" alt="Image" class="md:ml-auto block md:h-full" style="width: 1024px; height: 1024px; clip-path: polygon(8% 0, 100% 0%, 100% 100%, 0 100%)" />
                        </div>
                    </div>
                </div>
            </div>
...
const logoUrl = computed(() => {
    return `assets/img/logo/fanterbanterlogo.svg`;
});
</script>
